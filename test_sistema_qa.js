...
const verificarHtml = fs.existsSync('verificar.html') ? fs.readFileSync('verificar.html', 'utf8') : '';
...
[
    ...
    ['tests/reportWord.test.js', 'Word com a formatação da tela: estilos em linha, flex/grid como tabela com as larguras reais, caixa alta, mapas como imagem, cabeçalho uma vez e rodapé do Word com campos de página'],
    ['tests/reportDocx.test.js', 'Word .docx: ZIP (CRC-32), corpo em HTML por altChunk e rodapé de verdade em OOXML com data, SHA-256, QR e campos Página X de Y; A4/A3, retrato/paisagem e opções do rodapé desligadas'],
    ...
    ['tests/layerFilterFields.test.js', 'Filtro de Camadas: Exibição das abas de origem dos campos e modal de personalização dos campos visíveis']
