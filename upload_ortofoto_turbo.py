...
Interface Gráfica Nativa (PyQt5) integrada ao ambiente QGIS.
"""
...
try:
    ...
    class UploadWorkerThread(QtCore.QThread):
    ...
    def run_gui(initial_folder=None):
        print(f"[-] Erro ao carregar interface PyQt5: {e_import}")
